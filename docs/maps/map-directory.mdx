...
# Installation
The installation process is different depending on how and when the map was made my the modder. For maps that use [Kronifer's Map Manager](https://github.com/Kronifer/subwaybuilder-patcher/releases) (🟢), they all use the same, streamlined process, which can be found at the [installation guide](https://subwaybuildermodded.com/wiki/guides/map-installation-guide). For maps that use the `serve` method (🟡), use the [legacy installation guide](https://subwaybuildermodded.com/wiki/guides/legacy-map-installation-guide), as the process is a bit different and differs from map to map. For maps that have not yet been updated to v1.0.0 (🔴), you have to manually port them to use the new modding API. You can find a tutorial on how to do that at the [porting guide](https://subwaybuildermodded.com/wiki/guides/map-porting-guide).

 - [Installation Guide](https://subwaybuildermodded.com/wiki/guides/map-installation-guide) (v1.0.0 + [Kronifer's Map Manager](https://github.com/Kronifer/subwaybuilder-patcher/releases))
 - [Legacy Installation Guide](https://subwaybuildermodded.com/wiki/guides/legacy-map-installation-guide) (v1.0.0)
 - [Porting Guide](https://subwaybuildermodded.com/wiki/guides/map-porting-guide) (pre-v1.0.0)
...
🟢 Ready to play, follow [installation guide](https://subwaybuildermodded.com/wiki/guides/map-installation-guide)\
🟡 Needs to be ported to the Map Manager, follow the [legacy installation guide](https://subwaybuildermodded.com/wiki/guides/legacy-map-installation-guide)\
🔴 Needs to be ported to v1.0.0, follow the [porting guide](https://subwaybuildermodded.com/wiki/guides/map-porting-guide)

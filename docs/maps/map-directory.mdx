...
## Installation
The installation process is different depending on how and when the map was made my the modder. For maps that use [Kronifer's Map Manager](https://github.com/Kronifer/subwaybuilder-patcher/releases) (🟢), they all use the same, streamlined process, which can be found at the [installation guide](/wiki/guides/map-installation-guide). For maps that use the `serve` method (🟡), use the [legacy installation guide](/wiki/guides/legacy-map-installation-guide), as the process is a bit different and differs from map to map.

...
## Step 2 - Extracting the Files {#extracting-the-files}
...
## Step 3 - Zipping the Files {#zipping-the-files}
...
## Step 4 - Adding the Map {#adding-the-map}
...
## Step 5 - Launching Subway Builder {#launching-subway-builder}
